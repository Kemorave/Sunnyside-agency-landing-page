...
function App() {
  ...
  return (
    <div onClick={(e) => {
      if (!isDropDownOpen || e.target?.id === 'navbut' || e.target?.id === 'dropcontent' || e?.target?.alt === 'but')
        return;
      setDropDown(false);
    }}>
      ...
      sm:bg-[url('../publicimages/desktop/image-header.jpg')]">
        <div className="p-10  flex items-center justify-between">
          ...
          <div className='hidden md:flex justify-between flex-row '>
            ...
            <p className='header-nav' >Services
            </p>
            <p className='header-nav' >Projects
            </p>
            <p className='header-nav' >
              Contact
            </p>
        ...
        <div className='static'>
          <div id="dropdown" class={`absolute flex flex-col transition ${isDropDownOpen ? 'ease-in-out delay-150 scale-100' : ' ease-in-out delay-150   scale-0'}
        md:hidden transition-all duration-300 z-10 w-[80%] mx-[10%]  bg-white`}>
            <svg className='absolute -top-6 -right-3 fill-white w-10 '
              preserveAspectRatio="xMidYMid meet">
              <path fill="none" d="M0 0h32v32H0z" />
              <path d="M28 8v20H8z" />
            </svg>
            <ul id='dropcontent' class=" flex flex-col items-center gap-1
             py-5" >
              <li>
                <p className='header-nav-mobile' >About</p>
              </li>
              <li>
                <p className='header-nav-mobile' >Services</p>
              </li>
              <li>
                <p className='header-nav-mobile' >Projects</p>
              </li>
              <li>
                <p className='header-nav-mobile' >Contact</p>
              </li>
            </ul>
          </div>
      ...
      <main>
        ...
        <footer className='flex gap-5 flex-col pt-10 items-center bg-[#86f0d9]'>
          ...
          <div className='flex  gap-10'>
            <p className='fotter-nav'>About</p>
            <p className='fotter-nav'>
              Services</p>
            <p className='fotter-nav'>
              Projects
            </p >
